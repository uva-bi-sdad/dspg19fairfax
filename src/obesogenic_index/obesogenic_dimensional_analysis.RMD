...
write_csv(obesity.df, "./data/working/Obesogenic_final_data/2019_8_04_obesogenic_final.csv")
obesity.df %>% 
  nest(-id_type) %>%
  write_rds(., "./data/working/Obesogenic_final_data/2019_8_04_obesogenic_final_nested.RDS")
```
