...
<img src="obesogenic_dimensional_analysis_files/figure-markdown_github/unnamed-chunk-3-5.png" width="90%" /><img src="obesogenic_dimensional_analysis_files/figure-markdown_github/unnamed-chunk-3-6.png" width="90%" />
    ...
    ##  [1]  1.17  0.88  0.75  0.65  0.54  0.45  0.38  0.30  0.24  0.16  0.10
    ## [12]  0.03 -0.03 -0.08 -0.13 -0.18 -0.24 -0.30 -0.35 -0.40 -0.45 -0.50
    ## [23] -0.55 -0.60 -0.66
    ## 
    ...
    ##  [1] 2.03 1.84 1.71 1.61 1.50 1.41 1.35 1.26 1.20 1.11 1.06 0.99 0.93 0.88
    ## [15] 0.82 0.77 0.71 0.66 0.60 0.55 0.50 0.45 0.40 0.35 0.30
    ## 
    ## [[2]]
    ## Call: fa.parallel(x = .x)
    ## Parallel analysis suggests that the number of factors =  5  and the number of components =  4 
    ...
    ## 
    ##  eigen values of simulated factors
    ##  [1]  1.17  0.91  0.77  0.66  0.54  0.46  0.37  0.30  0.23  0.16  0.09
    ## [12]  0.04 -0.03 -0.08 -0.15 -0.20 -0.26 -0.31 -0.36 -0.40 -0.45 -0.49
    ## [23] -0.54 -0.60 -0.66
    ## 
    ##  eigen values of components 
    ...
    ## 
    ##  eigen values of simulated components
    ##  [1] 2.05 1.88 1.73 1.62 1.50 1.43 1.33 1.26 1.19 1.11 1.05 0.99 0.92 0.88
    ## [15] 0.81 0.75 0.69 0.65 0.59 0.55 0.51 0.46 0.41 0.36 0.30
    ## 
    ## [[3]]
    ## Call: fa.parallel(x = .x)
    ## Parallel analysis suggests that the number of factors =  5  and the number of components =  4 
    ...
    ## 
    ##  eigen values of simulated factors
    ##  [1]  1.18  0.94  0.77  0.66  0.56  0.46  0.37  0.29  0.23  0.16  0.10
    ## [12]  0.02 -0.04 -0.09 -0.15 -0.20 -0.25 -0.30 -0.35 -0.40 -0.45 -0.50
    ## [23] -0.54 -0.61 -0.68
    ## 
    ##  eigen values of components 
    ...
    ## 
    ##  eigen values of simulated components
    ##  [1] 2.06 1.91 1.73 1.62 1.52 1.42 1.33 1.25 1.19 1.12 1.05 0.98 0.91 0.86
    ## [15] 0.80 0.75 0.70 0.65 0.60 0.55 0.50 0.46 0.41 0.35 0.28
