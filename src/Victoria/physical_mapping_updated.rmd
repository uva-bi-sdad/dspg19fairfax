...
Pool Observation: From what I can tell; looks decent. 
...
Fitness Center Observations: Meant to represent gyms. This is not reliable... not enough data points!
Use: No
...
Sports Center Observations: This one is a bit muddy... it can be considered a community center, recreation center, athletic complex, etc. 
Overall, this one does not include all possible google map outcomes, but it has a fairly spread distribution that may be useful.
Use: yes
...
Nature Reserve Observations: Sparse, but good for overlay with other nature maps 
Use: Yes 
...
National Park Observations: On this map we see Wolftrap National Park. That's all. The iffy thing about all the nature maps is the differing names... national park/nature reserve/forest preserve, all yield different results on google maps.
Use: Yes 
...
Dog Park Observations: Pretty good when cross-checking with Google! There were even some on here that Google didn't catch. Also, Google does yield more results for dog park search BUT Google plots parks... overgeneralizing. 
Use: Yes 
...
Fairfax Garden Observations: Seems like a decent overlay to add to park/nature reserve. Cross-checked points on Google
Use: Yes
...
Track Obs: OSM refers to this as a paved closed-loop for running. Note that this differs from hiking/jogging trails, which moreso fall under nature reserve/park type searches. Checking Google for variations of "track" did not yield useful result... This spread looks promising, but no way to cross-check   
Use: Maybe?
...
Another Note: OSM also has trails (routes)... trouble plotting them, but they may be promising.
-Also curious: I wonder if there is potential for reporting bias in certain areas? Maybe the less well-off areas have less access to internet/phones/OSM/motivation to post to this site
